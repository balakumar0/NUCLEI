...
parse: nuclei.c general.c nuclei.h lisp.h general.h
	$(CC) nuclei.c linked.c general.c $(RELEASE) -o parse $(LIBS)

parse_s: nuclei.c general.c nuclei.h lisp.h general.h
	$(CC) nuclei.c linked.c general.c $(SANI) -o parse_s $(LIBS)

parse_v: nuclei.c general.c nuclei.h lisp.h general.h
...
extension: extension.c linked.c general.c extension.h lisp.h general.h
	   $(CC) extension.c linked.c general.c $(RELEASE) -o extension $(LIBS)
...
clean:
	rm -f parse parse_s parse_v interp interp_s interp_v extension $(PRES) $(IRES)
